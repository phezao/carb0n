<template>
  <div class="pt-48 mx-auto text-center relative overflow-hidden">
    <div class="md:px-32">
        <div class="mb-8">
        ...
        <img :src="imagePath('clouds.png')" alt="" class="hidden md:block absolute top-96 -left-36 w-1/4">
        <img :src="imagePath('clouds.png')" alt="" class="hidden md:block absolute top-28 -right-32 cloud-inverted w-1/4">
