  ...
  <div class="pt-48 text-center ">
    <section class="w-full h-full relative overflow-hidden">
      <div class="mb-8 mx-4">
        ...
        <img :src="imagePath('clouds.png')" alt="" class="hidden md:block absolute top-12 -left-56 w-1/4">
        <img :src="imagePath('clouds.png')" alt="" class="hidden md:block absolute top-0 -right-36 cloud-inverted w-1/4">
    ...
    <div class="">
      ...
      <section>
        <div class="flex justify-center gap-16 my-24 flex-col md:flex-row">
          <div class="flex flex-col gap-48 items-center">
      ...
      <section>
        <div class="hidden md:block projects overflow-hidden">
